...
--%>
<%@ page import="JavaBean.Hon" %>
<%@ page import="java.util.List" %>
<%@ page import="JavaBean.BookDao" %>
...
<body>
<%
    List<Hon> all=new BookDao().orderByrecommand();
                ...
                <div class="blockcontent">
                    <div style="padding-left: 10px">
                        <ul class="ultops">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/BookServlet?dowhat=searchprice&year=2023">2023</a>
                                <a href="${pageContext.request.contextPath}/BookServlet?dowhat=searchprice&year=2022">2022</a>
                                <a href="${pageContext.request.contextPath}/BookServlet?dowhat=searchprice&year=2021">2021</a>
                                <a href="${pageContext.request.contextPath}/BookServlet?dowhat=searchprice&year=2020">2020</a><br>
