...
<div class="title-line">
    <span class="h3 tit">添加书籍</span>
</div>
<div class="container">
    <div class="text-center">
        <form action="${pageContext.request.contextPath}/BookServlet?dowhat=add" method="post" onsubmit="return check()" name="form">
            <span class="h3">封面</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" id="cover" placeholder="输入封面地址" class="box" name="cover" value="img\暂无图片.jpg">
            <br>
            <br />
            <br />
            <span class="h3">书名</span>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" id="name" placeholder="输入书的名字" class="box" id="password" name="name"/>
            <br />
            <span id="tip" style="color: #f66495;"></span>
            <br />
            <br />
            <span class="h3">作者</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" id="author" placeholder="输入作者" class="box" name="author">
            <br>
            <br />
            <br />
            <span class="h3">热度</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" id="heat" placeholder="输入热度" class="box" name="heat">
            <br>
            <br />
            <br />
            <span class="h3">更新日期</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="date" id="date" class="box" name="date">
            <br>
            <br />
            <br />
            <span class="h3">这本轻小说真厉害</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" id="price" placeholder="输入年份" class="box" name="price">
            <br>
            <br />
            <br />
            <input type="submit" value="添加" class="zhu"/>
            <br />
        </form>
    </div>
</div>
